...
namespace WikiHero.Services
{
    public interface IApiComicsVine 
    {
        ...
        Task<ResultCharacter> GetMoreCharacter(string api_key, int offset);
        ...
        Task<ResultSeries> GetMoreSeries(string api_key, int offset);
        ...
        Task<ResultVolume> GetMoreVolumes(string api_key, int offset);
        ...
        Task<ResultCharacter> GetCharacter(string api_key);
        ...
        Task<ResultSeries> GetSeries(string api_key);
        ...
        Task<ResultVolume> GetMVolumes(string api_key);
        ...
        Task<ResultComics> VolumeComics(string api_key, int id);
        ...
        Task<ResultSeries> SearchSeries(string name, string api_key, int offset);
        ...
        Task<Publisher> FindPublisher(string api_key, int id);
        ...
        Task<ResultCharacter> SearchCharacters(string name, string api_key, int offset);
        [Get("/api/character/4005-{id}?format=json& api_key={api_key}")]
        Task<Character> FindCharacter(int id, string api_key);
        [Get("/api/videos?format=json&filter=name:{name}&api_key={api_key}&limit=30")]
        Task<ResultVideo> GetVideo(string api_key,string name);
        ...
        Task <ResultCharacter> FindEnenmyCharacter(string api_key, string filter);
